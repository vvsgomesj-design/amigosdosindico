...
if 'categorias_dinamicas' not in st.session_state:
    ...
    "03. Combate a Incêndio": {
        "emoji": "🔥",
        "itens":          {"desc": "Validade dos extintores", "norma": "NBR 12693", "detalhe": "Verificar carga, pressão e prazo de recarga. Troca imediata se vencido."},
    ...
    "09. Elevadores": {
        "emoji": "🛗",
        "itens":             {"desc": "Contrato de manutenção de elevadores", "norma": "NBR 16046", "detalhe": "Manter contrato ativo com empresa credenciada. Verificar ART."},
    ...
    "10. Documentação e Legal": {
        "emoji": "📄",
        "itens":             {"desc": "Laudo elétrico", "norma": "NR-10", "detalhe": "Exigido em condomínios. Deve ser renovado a cada 5 anos."},
